...
import com.devnihwl.dscatalog.tests.Factory;
import com.devnihwl.dscatalog.tests.TokenUtil;
...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		doThrow(NotFoundException.class).when(service).deleteById(nonExistingId);
